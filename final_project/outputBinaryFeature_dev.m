function outputBinaryFeature_dev(config, config_fg, name, name_fg, action, divide2, traintest, flipped, filepath, fileflippedpath, filepath_fg, fileflippedpath_fg, filegt)
